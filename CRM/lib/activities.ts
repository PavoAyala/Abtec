...
export const getActivity = (id: string) => getDocument<Activity>('activities', id);
...
export const subscribeToActivities = (
  ...
  return subscribeToCollection<Activity>('activities', callback, ...constraints);
};

export const getUpcomingTasks = async (ownerId?: string): Promise<Activity[]> => {
