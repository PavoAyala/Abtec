    ...
    <div className="container">
      ...
      <div className="card" style={{ marginTop: '20px' }}>
        ...
        <div style={{ marginTop: '15px' }}>
          <button className="btn btn-secondary" style={{ marginRight: '10px' }}>Firebase</button>
          <button className="btn btn-secondary" style={{ marginRight: '10px' }}>Slack</button>
      ...
      <div className="card" style={{ marginTop: '20px' }}>
        ...
        <p style={{ marginTop: '10px' }}>
          ...
          <strong>Firebase Project:</strong> abtec-8f31e<br />
