...
exports.onDealUpdated =
	exports.onDealStageChanged =
	exports.onDealCreated =
		void 0;
...
exports.onDealStageChanged = functions.firestore
	...
	.onUpdate(async (change, context) => {
		...
		if (
			after.contactId &&
			(after.stage === models_1.DealStage.Won ||
				after.stage === models_1.DealStage.Lost)
		) {
			const contactRef = firebase_1.db
				.collection("contacts")
				.doc(after.contactId);
			const contactUpdate = {
				lifecycleStage:
					after.stage === models_1.DealStage.Won ? "customer" : "lost",
			};
