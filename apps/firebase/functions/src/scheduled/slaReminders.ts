 ...
 */
export const checkSlaDeadlines = functions.scheduler
  .onSchedule('every 15 minutes', async () => {
    ...
    const atRiskQuery = db
      ...
      .where('slaDeadline', '<=', admin.firestore.Timestamp.fromDate(
 ...
 */
export const checkOverdueTasks = functions.scheduler
