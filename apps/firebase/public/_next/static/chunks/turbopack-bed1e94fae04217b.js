(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
	...
	{
		otherChunks: [
			"static/chunks/071964ec27275b01.js",
			"static/chunks/8332209b40140938.js",
			"static/chunks/b35832465c4eec72.js",
			"static/chunks/88d82d88cff3722b.js",
			"static/chunks/3a4ca3ba89748967.js",
		],
		runtimeModuleIds: [64851],
	},
]),
	(() => {
		let e;
		...
		const O = Symbol("turbopack queues"),
		...
		async function S(e, t, r) {
			...
			if (s.length > 0) {
				...
				const r = new Set();
				for (const e of i) P.has(e) || r.add(e);
				for (const n of r) {
					const r = E(e, t, K(n));
					P.set(n, r), s.push(r);
				}
				...
				for (const o of ((n = E(e, t, K(r.path))), i)) P.has(o) || P.set(o, n);
			}
			for (const e of o) $.has(e) || $.set(e, n);
			await n;
		}
		R.l = function (e) {
