	...
	(e) => {
		...
		function d() {
			const { data: e } = (0, i.default)(
					r.SWRKeys.activities,
					r.fetcher.activities,
					{
						revalidateOnFocus: !1,
				...
				d = [
					...
					{ key: "description", label: "Descripción", sortable: !0 },
					{
						key: "dueDate",
						label: "Fecha Límite",
						render: (e) =>
					...
					},
					{
						...
						render: (e) =>
							(0, t.jsx)("span", {
								className: `badge ${e.completedAt ? "badge-green" : "badge-yellow"}`,
								children: e.completedAt ? "Completada" : "Pendiente",
							}),
					},
				];
			return (0, t.jsxs)("div", {
					...
					(0, t.jsxs)("div", {
						...
						children: [
							(0, t.jsxs)("div", {
								...
								children: [
									(0, t.jsx)("h2", { children: "Actividades" }),
									(0, t.jsx)("p", { children: "Tareas y seguimiento" }),
								],
							}),
							(0, t.jsx)("div", {
