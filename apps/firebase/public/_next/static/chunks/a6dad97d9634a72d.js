!(() => {
	...
	var r,
		...
		u = !a(() => 7 !== Object.defineProperty({}, 1, { get: () => 7 })[1]),
		s = !a(() => {
			var t = (() => {}).bind();
			return "function" != typeof t || Object.hasOwn(t, "prototype");
		}),
		...
		O = Object,
		x = b("".split),
		R = a(() => !O("z").propertyIsEnumerable(0))
			? (t) => ("String" === E(t) ? x(t, "") : O(t))
			: O,
		P = (t) => null == t,
		A = TypeError,
		j = (t) => {
		...
		T =
			void 0 === I && void 0 !== I
				...
				: (t) => "function" == typeof t,
		M = (t) => ("object" == typeof t ? null !== t : T(t)),
		L = function (t, e) {
	...
	var W = n,
		...
		it = (t) => ot(j(t)),
		at = b({}.hasOwnProperty),
		ut = Object.hasOwn || ((t, e) => at(it(t), e)),
		st = 0,
		ct = Math.random(),
		ft = b((1).toString),
		lt = (t) => "Symbol(" + (void 0 === t ? "" : t) + ")_" + ft(++st + ct, 36),
		ht = i.Symbol,
		pt = nt("wks"),
		...
		Et = (t) => (St ? wt.createElement(t) : {}),
		Ot =
			!u &&
			!a(() => 7 !== Object.defineProperty(Et("div"), "a", { get: () => 7 }).a),
	...
	var re,
		...
		oe = e((t) => {
			var e = zt.CONFIGURABLE,
				...
				c = b("".replace),
				f = b([].join),
				l = u && !a(() => 8 !== i(() => {}, "length", { value: 8 }).length),
		...
		Oe = { f: Object.getOwnPropertyNames || ((t) => we(t, Ee)) },
		...
		Ie = (ke.normalize = (t) => String(t).replace(je, ".").toLowerCase()),
		Te = (ke.data = {}),
		Me = (ke.NATIVE = "N"),
		Le = (ke.POLYFILL = "P"),
		Ue = ke,
	...
	var Tn = (t, e, r) => {
		...
		Ln = dt("iterator"),
		Un = Array.prototype,
		Nn = (t) => void 0 !== t && (un.Array === t || Un[Ln] === t),
		Cn = (t, e, r) => {
	...
	var vo = b([].slice),
		...
		So =
			a(() => {
				...
				? (t) => !!M(t) && (!bo || "ArrayBuffer" !== E(t)) && (!wo || wo(t))
				: wo,
		Eo = !a(() => Object.isExtensible(Object.preventExtensions({}))),
		Oo = e((t) => {
			var e = Ct.f,
				r = !1,
				n = lt("meta"),
				...
				a = (t.exports = {
					...
					onFreeze: (t) => (Eo && r && So(t) && !ut(t, n) && i(t), t),
				});
			Jt[n] = !0;
		}),
		xo = TypeError,
		...
		Ao = (t, e, r) => {
			var n,
				...
				v = !(!r || !r.INTERRUPTED),
				d = ar(e, r && r.that),
				g = (t) => (n && Tn(n, "normal", t), new Ro(!0, t)),
				y = (t) =>
					l
	...
	var Bo = Map.prototype,
		...
		Ho = Do.set,
		$o = b([].push),
		Ko = a(() => 1 !== zo.groupBy("ab", (t) => t).get("a").length);
	Ce(
	...
	var ci = (t, e, r) => {
		...
		vi = pi(new fi()).next,
		di = (t, e, r) =>
			r ? ci({ iterator: pi(t), next: vi }, (t) => e(t[1], t[0])) : hi(t, e);
	Ce(
		{ target: "Map", proto: !0, real: !0, forced: !0 },
		{
			every: function (t) {
	...
	Ce(
		...
		{ isFinite: Number.isFinite || ((t) => "number" == typeof t && Xi(t)) },
	);
	var Ji = Math.floor,
		Qi = Number.isInteger || ((t) => !M(t) && isFinite(t) && Ji(t) === t);
	Ce({ target: "Number", stat: !0 }, { isInteger: Qi }),
		Ce({ target: "Number", stat: !0 }, { isNaN: (t) => t != t });
	var Zi = Math.abs;
	Ce(
		{ target: "Number", stat: !0 },
		{ isSafeInteger: (t) => Qi(t) && Zi(t) <= 9007199254740991 },
	),
		Ce(
			{ target: "Number", stat: !0, nonConfigurable: !0, nonWritable: !0 },
	...
	var pa = b(v.f),
		...
		ma = ya.entries;
	Ce({ target: "Object", stat: !0 }, { entries: (t) => ma(t) }),
		Ce(
	...
	Ce({ target: "Object", stat: !0, forced: ba }, { keys: (t) => _e(it(t)) });
	var wa =
		Object.is ||
		((t, e) => (t === e ? 0 !== t || 1 / t == 1 / e : t != t && e != e));
	Ce({ target: "Object", stat: !0 }, { is: wa });
	var Sa = ya.values;
	Ce({ target: "Object", stat: !0 }, { values: (t) => Sa(t) }),
	...
	var Wa = (t) => void 0 !== t && (ut(t, "value") || ut(t, "writable"));
	Ce(
		{ target: "Reflect", stat: !0 },
		{
			get: function t(e, r) {
		...
		Ce(
			...
			{ getOwnPropertyDescriptor: (t, e) => Rt.f(kt(t), e) },
		),
		Ce(
			{ target: "Reflect", stat: !0, sham: !Vr },
			{ getPrototypeOf: (t) => Qr(kt(t)) },
		),
		Ce({ target: "Reflect", stat: !0 }, { has: (t, e) => e in t }),
		Ce(
			{ target: "Reflect", stat: !0 },
			{ isExtensible: (t) => (kt(t), So(t)) },
		),
	...
	var Ha = Oo.getWeakData,
		...
		Ya = b([].splice),
		Xa = 0,
		Ja = (t) => t.frozen || (t.frozen = new Qa()),
		Qa = function () {
			this.entries = [];
		},
		Za = (t, e) => Ga(t.entries, (t) => t[0] === e);
	Qa.prototype = {
		get: function (t) {
			var e = Za(this, t);
			if (e) return e[1];
	...
	var mu = L("Map"),
		...
		xu = {
			...
			toKey: (t) => (void 0 === t || "symbol" == typeof t ? t : String(t)),
		},
		Ru = xu.toKey,
		Pu = xu.set;
	Ce(
	...
	var _s = zt.PROPER,
		...
		Bs = RegExp.prototype,
		Ds = Bs[Fs];
	(a(() => "/a/b" !== Ds.call({ source: "a", flags: "b" })) ||
		(_s && Ds.name !== Fs)) &&
		ie(
			Bs,
			Fs,
		...
		(Gs = function (t) {
			...
			if (
				(v &&
					((d = Xs(d, "y", "")),
					-1 === Ys(d, "g") && (d += "g"),
					(m = Js(l, this.lastIndex)),
					this.lastIndex > 0 &&
						(!this.multiline ||
							(this.multiline && "\n" !== Vs(l, this.lastIndex - 1))) &&
						((g = "(?: " + g + ")"), (m = " " + m), y++),
					(r = new RegExp("^(?:" + g + ")", d))),
				...
				v
					? o
						? ((o.input = Js(o.input, y)),
							...
							(this.lastIndex += o[0].length))
						: (this.lastIndex = 0)
					: Qs &&
						o &&
						(this.lastIndex = this.global ? o.index + o[0].length : n),
				tc &&
					o &&
					o.length > 1 &&
					f($s, o[0], r, function () {
	...
	u &&
		a(() => {
			...
			var e = {},
				...
				n = t ? "dgimsy" : "gimsy",
				o = (t, n) => {
					Object.defineProperty(e, t, { get: () => ((r += n), !0) });
				},
				i = {
					dotAll: "s",
					global: "g",
	...
	var hf = Set.prototype,
		...
		bf = b(yf.keys),
		wf = bf(new gf()).next,
		Sf = (t, e, r) => (r ? ci({ iterator: bf(t), next: wf }, e) : mf(t, e)),
		Ef = pf.Set,
		Of = pf.add,
		xf = (t) => {
			var e = new Ef();
		...
		Rf = ln(pf.proto, "size", "get") || ((t) => t.size),
		Pf = "Invalid size",
		Af = RangeError,
		jf = TypeError,
		kf = Math.max,
	...
	var el = dt("iterator"),
		...
		nl = L("Set"),
		ol = (t) =>
			((t) => M(t) && "number" == typeof t.size && T(t.has) && T(t.keys))(t)
				? t
				: ((t) => {
							if (P(t)) return !1;
							var e = rl(t);
	...
	H ||
		...
		ie(jl, "withoutSetter", (t) => Hl(lt(t), t)),
		(v.f = Gl),
		(Ct.f = $l),
		(Be.f = Kl),
		(Rt.f = Vl),
		...
		Ce(
			...
			{
				create: (t, e) => (void 0 === e ? Ve(t) : Kl(Ve(t), e)),
				defineProperty: $l,
				defineProperties: Kl,
	...
	if (
		(Mo(
			Ev,
			{
				...
				sort: function () {
					var t = Wp(this);
					_p(t.entries, (t, e) => (t.key > e.key ? 1 : -1)), t.updateURL();
				},
				forEach: function (t) {
					for (
						var e,
	...
	xg.prototype = {
				...
				switch (((o = n[f]), c)) {
					...
					case sg:
						if (((this.scheme = r.scheme), o === Wv))
							(this.username = r.username),
								...
								(this.path = vo(r.path)),
								(this.query = r.query);
						else if ("/" === o || ("\\" === o && this.isSpecial())) c = cg;
						else if ("?" === o)
							(this.username = r.username),
								(this.password = r.password),
								(this.host = r.host),
					...
					case hg:
						if ("@" === o) {
							...
							for (var d = 0; d < i.length; d++) {
								...
								if (":" !== g || v) {
									var y = Qd(g, Jd);
									v ? (this.password += y) : (this.username += y);
								} else v = !0;
							}
							l = "";
						} else if (
						...
						if (":" !== o || p) {
							if (
								...
								if (
									...
									return;
								if ((a = this.parseHost(l))) return a;
								if (((l = ""), (c = bg), e)) return;
								continue;
							}
							"[" === o ? (p = !0) : "]" === o && (p = !1), (l += o);
						...
						if (!Sd(_d, o)) {
							if (
								...
								if ("" !== l) {
									...
									(this.port =
										this.isSpecial() && m === Zd[this.scheme] ? null : m),
										(l = "");
								}
								if (e) return;
								c = bg;
					...
					case bg:
						if (this.isSpecial()) {
							...
							} else (this.fragment = ""), (c = Og);
						else (this.query = ""), (c = Eg);
						break;
					case wg:
						if (
							o === Wv ||
								...
								"%2e%2e" === u
									...
									: rg(l)
										...
										: ("file" === this.scheme &&
												!this.path.length &&
												tg(l) &&
												(this.host && (this.host = ""), (l = wd(l, 0) + ":")),
											Rd(this.path, l)),
								(l = ""),
								"file" === this.scheme && (o === Wv || "?" === o || "#" === o))
							)
								for (; this.path.length > 1 && "" === this.path[0]; )
									Ad(this.path);
							"?" === o
								? ((this.query = ""), (c = Eg))
								: "#" === o && ((this.fragment = ""), (c = Og));
						} else l += Qd(o, Xd);
						break;
					case Sg:
						"?" === o
					...
					case Eg:
						e || "#" !== o
							? o !== Wv &&
								("'" === o && this.isSpecial()
									? (this.query += "%27")
									: (this.query += "#" === o ? "%23" : Qd(o, Vd)))
							: ((this.fragment = ""), (c = Og));
						break;
					case Og:
						o !== Wv && (this.fragment += Qd(o, Yd));
				}
				f++;
			}
		},
		...
		serialize: function () {
			...
			return (
				null !== o
					? ((c += "//"),
						this.includesCredentials() && (c += r + (n ? ":" + n : "") + "@"),
						(c += Gd(o)),
						null !== i && (c += ":" + i))
					: "file" === e && (c += "//"),
				(c += this.cannotBeABaseURL ? a[0] : a.length ? "/" + Ed(a, "/") : ""),
				null !== u && (c += "?" + u),
				null !== s && (c += "#" + s),
				c
			);
	...
	if (
		...
		(im.f = bm = (t) => (t === vm || void 0 === t ? new Gy(t) : wm(t))),
		...
		{ target: "Promise", stat: !0, forced: Lm },
		{
			race: function (t) {
				var r = im.f(this),
					n = r.reject,
					o = Xy(() => {
						var o = J(this.resolve);
						Ao(t, (t) => {
							f(o, this, t).then(r.resolve, n);
						});
					});
	...
	if (Vm)
		var Ym = [
			...
			Xm =
				ArrayBuffer.isView ||
				((t) => t && Ym.indexOf(Object.prototype.toString.call(t)) > -1);
	function Jm(t) {
		if (
	...
	function Zm(t) {
		...
		return $m && (e[Symbol.iterator] = () => e), e;
	}
	function tb(t) {
		(this.map = {}),
			t instanceof tb
	...
	(tb.prototype.append = function (t, e) {
		...
		(tb.prototype.has = function (t) {
			return Object.hasOwn(this.map, Jm(t));
		}),
		...
		(tb.prototype.forEach = function (t, e) {
			for (var r in this.map)
				Object.hasOwn(this.map, r) && t.call(e, this.map[r], r, this);
		}),
