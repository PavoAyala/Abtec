...
import { 
	Droplets, Zap, MapPin, Wrench, ShoppingBag, Headphones, 
...
export default function NosotrosBoilerSolar(): JSX.Element {
	...
	const projects: ProjectItem[] = [
		{
			...
			boilers: "40 piezas",
			description: "Distribución y asesoría en diseño de instalación de boiler solares.",
				...
				<section className="relative w-full py-24 md:py-32 bg-slate-950 overflow-hidden">
					...
					<div className="max-w-7xl mx-auto px-6 lg:px-10 relative z-10 text-center">
						<div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/20 text-primary border border-primary/30 w-fit mb-6 mx-auto">
							<Droplets className="w-4 h-4 animate-spin-slow text-primary" />
						...
						<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
							...
							<div className="bg-white rounded-2xl border border-gray-150 p-8 shadow-md hover:shadow-xl transition-all duration-300 group hover:-translate-y-1">
								...
								<p className="text-gray-650 text-sm leading-relaxed">
									Suministro directo de boiler solares de última generación con componentes de alta calidad, garantizando eficiencia energética y durabilidad en cada instalación.
								</p>
							</div>
							...
							<div className="bg-white rounded-2xl border border-gray-150 p-8 shadow-md hover:shadow-xl transition-all duration-300 group hover:-translate-y-1">
								...
								<p className="text-gray-650 text-sm leading-relaxed">
									Asesoría integral en diseño e instalación de sistemas de boiler solar adaptados a tus necesidades específicas, con mano de obra certificada y profesional.
								</p>
							</div>
							...
							<div className="bg-white rounded-2xl border border-gray-150 p-8 shadow-md hover:shadow-xl transition-all duration-300 group hover:-translate-y-1">
								...
								<p className="text-gray-650 text-sm leading-relaxed">
									Soporte técnico continuo y mantenimiento preventivo para maximizar el rendimiento de tu sistema de boiler solar y extender su vida útil.
								</p>
							</div>
						</div>
					</div>
												...
												<div className={`lg:col-span-6 flex flex-col items-center justify-center text-center ${isEven ? 'order-1 lg:order-1' : 'order-1 lg:order-2'}`}>
													...
													<div className="space-y-3 mt-2 text-sm md:text-base font-sans">
														<p className="leading-relaxed">
															<span className="font-bold text-[#262660]">Nº de boiler instalados:</span>{" "}
															<span className="text-abtec-green font-semibold">{project.boilers}</span>
														</p>
														<p className="leading-relaxed">
															<span className="font-bold text-[#262660]">Descripción de proyecto:</span>{" "}
															<span className="text-abtec-green font-semibold">{project.description}</span>
														</p>
													</div>
												</div>
								...
								{formSubmitted ? (
									<div className="flex flex-col items-center justify-center py-16 text-center bg-white rounded-2xl p-8 shadow-sm">
										...
										<p className="text-slate-500 text-sm max-w-sm">
											Muchas gracias por contactarnos. Un especialista en proyectos de boiler solar se comunicará contigo a la brevedad.
										</p>
									</div>
								) : (
											...
											<div className="space-y-2">
												...
												<div className="relative">
													...
													>
														...
														<option value="distribucion">Distribución de Boiler Solar</option>
														<option value="atencion">Atención y Diseño</option>
														<option value="asistencia">Asistencia Técnica</option>
														<option value="comercial">Proyecto Comercial Boiler Solar</option>
							...
							<div className="lg:col-span-5 bg-[#E2E2EA] rounded-[32px] p-6 sm:p-8 flex flex-col justify-between shadow-sm border border-slate-200/40">
								<div>
									...
									<div className="relative w-full aspect-[16/10] rounded-[24px] overflow-hidden mb-6 shadow-sm">
										<Image
											src="/images/boiler-solar-info.jpg"
											alt="ABTEC Boiler Solar"
											fill
