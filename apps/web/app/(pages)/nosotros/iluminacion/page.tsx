...
import { 
	Lightbulb, Layers, Hammer, ShoppingBag, 
...
export default function NosotrosIluminacion(): JSX.Element {
	...
	const projects: ProjectItem[] = [
		{
			...
			details: [
				{ label: "Ubicación de proyecto", value: "Monterrey, Nuevo León." },
				{ label: "Nº de luminarias instaladas", value: "111 unidades." },
				{ label: "Marca de luminarias", value: "Philips." }
			]
		},
		{
			type: "PROYECTO COMERCIAL",
			title: "PARQUE RESIDENCIAL",
			location: "Monterrey, Nuevo León.",
			image: "/images/proyecto residencial.png",
			details: [
				{ label: "Ubicación de proyecto", value: "Monterrey, Nuevo León." },
				{ label: "Descripción del proyecto", value: "Estudio lumínico, suministro e instalación de luminarias de alumbrado público." }
			]
		}
	];
						...
						<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
							...
							<div className="bg-white rounded-2xl border border-gray-150 p-8 shadow-md hover:shadow-xl transition-all duration-300 group hover:-translate-y-1">
								...
								<p className="text-gray-650 text-sm leading-relaxed">
									Suministro directo de luminarias LED de última generación y alta eficiencia para naves industriales, comercios y vialidades públicas, trabajando con marcas líderes como Philips y Holophane.
								</p>
							</div>
							...
							<div className="bg-white rounded-2xl border border-gray-150 p-8 shadow-md hover:shadow-xl transition-all duration-300 group hover:-translate-y-1">
								...
								<p className="text-gray-650 text-sm leading-relaxed">
									Estudios y cálculos fotométricos en 3D bajo normas oficiales (NOM-025 y NOM-013) utilizando software avanzado como Dialux para garantizar la uniformidad y los niveles de lux requeridos.
								</p>
							</div>
							...
							<div className="bg-white rounded-2xl border border-gray-150 p-8 shadow-md hover:shadow-xl transition-all duration-300 group hover:-translate-y-1">
								...
								<p className="text-gray-650 text-sm leading-relaxed">
									Mano de obra certificada e ingeniería especializada para montaje físico de luminarias, cableado, colocación de postes de alumbrado público y puesta en marcha segura.
								</p>
							</div>
						</div>
					</div>
								...
								{formSubmitted ? (
									<div className="flex flex-col items-center justify-center py-16 text-center bg-white rounded-2xl p-8 shadow-sm">
										...
										<p className="text-slate-500 text-sm max-w-sm">
											Muchas gracias por contactarnos. Un especialista en proyectos de iluminación se comunicará contigo a la brevedad.
										</p>
									</div>
								) : (
											...
											<div className="space-y-2">
												...
												<div className="relative">
													...
													>
														...
														<option value="distribucion">Venta / Distribución de Luminarias</option>
														<option value="diseno">Diseño Lumínico / Estudio Fotométrico</option>
														<option value="instalacion">Instalación de Luminarias / Alumbrado Público</option>
														<option value="industrial">Proyecto Industrial LED</option>
														<option value="comercial">Proyecto Comercial LED</option>
													</select>
							...
							<div className="lg:col-span-5 bg-[#E2E2EA] rounded-[32px] p-6 sm:p-8 flex flex-col justify-between shadow-sm border border-slate-200/40">
								<div>
									...
									<div className="relative w-full aspect-[16/10] rounded-[24px] overflow-hidden mb-6 shadow-sm">
										<Image
											src="/images/usg 2.png"
											alt="ABTEC Iluminación"
											fill
									...
									<p className="text-slate-700 text-sm md:text-base leading-relaxed mb-6 font-sans">
										Recibir un presupuesto para tu proyecto es fácil y rápido a través de nuestros expertos con más de 24 años de experiencia en el mercado. Compártenos tus datos y pronto nos comunicaremos contigo para brindarte el estudio-cotización de iluminación LED que más se adapte a tus necesidades.
									</p>
								</div>
