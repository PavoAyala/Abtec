							...
							<div className="lg:col-span-5 bg-[#E2E2EA] rounded-[32px] p-6 sm:p-8 flex flex-col justify-between shadow-sm border border-slate-200/40">
								<div>
									...
									<p className="text-slate-700 text-sm md:text-base leading-relaxed mb-6 font-sans">
										Recibir un presupuesto para tu proyecto es fácil y rápido a través de nuestros expertos con más de 15 años de experiencia en el mercado. Compártenos tus datos y pronto nos comunicaremos contigo para brindarte el estudio-cotización de iluminación LED que más se adapte a tus necesidades.
									</p>
								</div>
