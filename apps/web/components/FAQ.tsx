...
export default function FAQ(): JSX.Element {
	const faqs = [
		...
		{
			question: "¿Qué garantía poseen los equipos y cuánto tiempo de vida tienen?",
			answer:
		...
		{
			question: "¿Seguiré pagando recibos de luz a CFE si instalo Paneles Solares Monterrey?",
			answer:
		...
		{
			question: "¿Se puede ampliar o reducir el sistema de Paneles Solares Monterrey en el futuro?",
			answer:
		...
		{
			question: "¿Qué pasa con los Paneles Solares Monterrey si cambio de domicilio?",
			answer:
					...
					<div>
						<div className="text-center mb-10">
							...
							<p className="text-gray-700 text-sm leading-relaxed mx-auto max-w-2xl">
								Respuestas a las preguntas más frecuentes en Proyectos de Paneles Solares Monterrey.
							</p>
						</div>
