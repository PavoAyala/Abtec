                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-10">
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                        <div className="max-w-2xl">
                            ...
                            <h3 className="text-secondary text-4xl md:text-5xl font-bold tracking-tight">Specialized Solar Solutions</h3>
                        </div>
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-10">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="group p-8 rounded-2xl bg-background-light border border-secondary/5 hover:border-primary/50 transition-all duration-300 hover:shadow-2xl hover:shadow-primary/10">
                            ...
                            <h4 className="text-secondary text-2xl font-bold mb-4">Installation</h4>
                        ...
                        <div className="group p-8 rounded-2xl bg-background-light border border-secondary/5 hover:border-primary/50 transition-all duration-300 hover:shadow-2xl hover:shadow-primary/10">
                            ...
                            <h4 className="text-secondary text-2xl font-bold mb-4">Maintenance</h4>
                            <p className="text-secondary/60 leading-relaxed">
                        ...
                        <div className="group p-8 rounded-2xl bg-background-light border border-secondary/5 hover:border-primary/50 transition-all duration-300 hover:shadow-2xl hover:shadow-primary/10">
                            ...
                            <h4 className="text-secondary text-2xl font-bold mb-4">Consulting</h4>
                            <p className="text-secondary/60 leading-relaxed">
