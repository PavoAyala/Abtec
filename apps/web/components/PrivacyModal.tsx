...
export default function PrivacyModal({ isOpen, onClose }: PrivacyModalProps): JSX.Element | null {
    useEffect(() => {
        if (isOpen) {
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-6" role="dialog" aria-modal="true">
            ...
            <div className="relative bg-white w-full max-w-4xl max-h-[90vh] overflow-hidden rounded-3xl shadow-2xl flex flex-col animate-in fade-in zoom-in duration-300">
                ...
                <div className="p-6 md:p-8 flex items-center justify-between border-b border-secondary/5 bg-background-light">
                    <div>
                        <h2 className="text-2xl md:text-3xl font-bold text-secondary tracking-tight">Aviso de Privacidad</h2>
                ...
                <div className="flex-1 overflow-y-auto p-6 md:p-10 custom-scrollbar">
                    <div className="text-secondary/80 space-y-8 leading-relaxed text-base md:text-lg">
                        ...
                        <div className="bg-background-light p-6 md:p-8 rounded-2xl border border-secondary/5">
                            <h3 className="text-secondary text-sm font-bold uppercase tracking-wider mb-4">Datos personales requeridos:</h3>
                        ...
                        <p>
                            Es importante informarle que usted tiene derecho al <span className="font-bold text-secondary border-b-2 border-primary/30">Acceso, Rectificación y Cancelación</span> de sus datos personales, a Oponerse al tratamiento de los mismos o a revocar el consentimiento que para dicho fin nos haya otorgado.
                        </p>

                        <p>
                            Para ello, es necesario que envíe la solicitud en los términos que marca la Ley en su Art. 29 a nuestro Departamento de Protección de Datos Personales vía correo electrónico a <a href="mailto:ventas@abtec.mx" className="font-bold text-primary hover:underline">ventas@abtec.mx</a>, el cual solicitamos confirme vía telefónica para garantizar su correcta recepción.
                        </p>

                        <p>
                            En caso de que no desee de recibir mensajes promocionales de nuestra parte, puede enviarnos su solicitud por medio de la dirección electrónica: <a href="mailto:ventas@abtec.mx" className="font-bold text-primary hover:underline">ventas@abtec.mx</a>
                        </p>
                        ...
                        <div className="pt-8 border-t border-secondary/10 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                            <p className="text-sm">
                                <span className="font-bold">Importante:</span> Cualquier modificación a este aviso de privacidad podrá consultarlo en <a href="https://www.abtec.mx" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-medium">www.abtec.mx</a>
                            </p>
                            <p className="text-xs font-medium text-secondary/30 uppercase tracking-widest">Última actualización: Feb 2025</p>
                        </div>
                    </div>
                </div>
