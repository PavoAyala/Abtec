      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex items-center gap-3">
            ...
            <span className="text-secondary/40 font-bold uppercase tracking-tighter">ABTEC © 2025</span>
          </div>
          ...
          <div className="flex gap-4">
            <a href="#" className="w-10 h-10 rounded-full bg-background-light flex items-center justify-center text-secondary/40 hover:bg-primary/20 hover:text-primary transition-all cursor-pointer group">
