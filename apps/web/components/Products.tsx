...
function ProductCard({ product }: { product: Product }): JSX.Element {
    ...
    return (
        <div
            className={`group relative overflow-hidden rounded-2xl border border-secondary/10 transition-all duration-500 hover:border-primary/40 hover:shadow-2xl hover:shadow-primary/15 hover:-translate-y-1 ${isLarge
        ...
        >
            ...
            <div
                className={`absolute rounded-full blur-3xl transition-all duration-700 group-hover:scale-150 group-hover:opacity-40 ${isLarge
            ...
            <div className="relative z-10 flex flex-col h-full">
                {/* Icon */}
                <div
                    className={`flex items-center justify-center rounded-xl transition-all duration-300 group-hover:scale-110 ${isLarge
                ...
                {/* Title */}
                <h3
                    className={`font-bold tracking-tight mb-3 ${isLarge
                ...
                {/* Description */}
                <p
                    className={`leading-relaxed flex-1 ${isLarge
                ...
                <Link
                    href="/#contacto"
                    className={`mt-4 inline-flex items-center gap-1 font-semibold text-sm transition-all duration-300 translate-x-0 opacity-0 group-hover:opacity-100 group-hover:translate-x-1 ${isLarge ? 'text-primary' : 'text-primary'
                        }`}
                >
                    <span>Cotizar</span>
