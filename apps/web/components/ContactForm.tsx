...
export default function ContactForm(): JSX.Element {
	...
	return (
		<section
			id="contacto"
			className="py-24 bg-secondary text-white relative overflow-hidden scroll-mt-20"
		>
				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
					<div>
						...
						<h3 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">
							Inicia tu Transición <br />
							Energética Hoy
						</h3>
						<p className="text-white/70 text-lg mb-10 max-w-md leading-relaxed">
							¿Listo para dar el siguiente paso? Completa el formulario y
							nuestros ingenieros especializados realizarán un análisis solar
							personalizado para tu propiedad.
						</p>
						<div className="flex flex-col gap-6">
							<div className="flex items-center gap-4">
								...
								<div>
									<p className="text-sm text-white/50 uppercase font-bold tracking-wider">
										Teléfono
									</p>
						...
						<form onSubmit={handleSubmit} className="space-y-6">
							<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
								<div className="flex flex-col gap-2">
									<label
										htmlFor="name"
										className="text-secondary text-sm font-bold uppercase tracking-wide"
									>
										Nombre Completo
									</label>
									<input
